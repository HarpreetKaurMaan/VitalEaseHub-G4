...
//Define GraphQL object type for vital signs
...
// Define GraphQL object type for Motivational Tips
...
// Define GraphQL object type for Alerts
...
// Define GraphQL object type for Symptoms
...
// Get the payload from the cookies
...
// Create a GraphQL mutation for adding new student
...
const mutation = new GraphQLObjectType({
  ...
  fields: function () {
    return {
      ...
      // a mutation to create a new vital sign
      createVital: {
        type: vitalType,
        args: {
      ...
      // a mutation to update a vital sign
      updateVital: {
        type: vitalType,
        args: {
      ...
      // a mutation to delete a vital sign
      deleteVital: {
        type: vitalType,
        args: {
          id: { type: GraphQLNonNull(GraphQLString) },
        ...
        resolve: function (root, params, context) {
          const deleteVital = VitalModel.findByIdAndDelete(params.id).exec();
          if (!deleteVital) {
            throw new Error("Error");
          }
          return deleteVital;
      ...
      // a mutation to create a new tip
      createTip: {
        type: tipType,
        args: {
      ...
      deleteTip: {
        ...
        resolve: function (root, params, context) {
          const deleteTips = TipModel.findByIdAndDelete(params.id).exec();
          if (!deleteTips) {
            throw new Error("Error");
          }
          return deleteTips;
      ...
      // a mutation to create a new alert
      createAlert: {
        type: alertType,
        args: {
      ...
      deleteAlert: {
        ...
        resolve: function (root, params, context) {
          const deleteAlert = AlertModel.findByIdAndDelete(params.id).exec();
          if (!deleteAlert) {
            console.log(error);
            throw new Error("Error");
          }
      ...
      // a mutation to create a new symptom
      createSymptom: {
        type: symptomsType,
        args: {
        ...
        resolve: async function (
          root,
          { selectedSymptom, patient, date, time }
        ) {
          try {
